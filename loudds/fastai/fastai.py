...
def _summary_part(classes: list, predictions: Tensor, targets: Tensor, losses: Tensor,
                  dataset: DeviceDataLoader, dataset_name: str):
...
def prepare_summary(learner: Learner, sets: dict = { DatasetType.Valid: 'validation', DatasetType.Test: 'test' }):
